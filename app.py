...
def input_pdf_text(uploaded_file):
    reader = PyPDF2.PdfReader(uploaded_file)  # Update here
    text = ""
...
input_prompt="""
You are an ATS (Applicant Tracking System) tasked with assessing resumes against provided job descriptions in a competitive job market. The ATS requires proficiency in various technical domains such as Software Engineering, Data Science,
Data Analytics, Big Data Engineering,web developer,Mobile App Developer,
DevOps Engineer, Machine Learning Engineer, Cybersecurity Analyst,Cloud Solutions Architect,
Database Administrator, Network Engineer,AI Engineer,Systems Analyst, Full stack Developer, UI/UX
Designer, Product Manager, Project Manager, Business Analyst, and more. Your objective is to meticulously assess
resumes against the provided job descriptions. In a Fiercly competitive job market, your expertise is crucial in 
offering top-notch guidance for resume enhancement. Assign precise matching percentages based on the JD
...
While generating the response put some space to seperate all the three sections.
"""
...
with col1:
    ...
    st.markdown("""<p style='text-align: justify;'>
            Introducing CareerCraft, an ATS-Optimized Resume Analyzer - your ultimate solution for optimizing job applications and 
                ...
                enhancement to career progression guidance, CareerCraft empowers users to stand out in today's competitive job 
                market. Streamline your job application process, enhance your skills, and navigate your career path with confidence.
...
with col1:
    ...
    if submit:
        if uploaded_file is not None:
            text = input_pdf_text(uploaded_file)  # Assuming you have a function to extract text from PDF
            response = get_gemini_response(input_prompt)  # Assuming you have a function to get Gemini response
